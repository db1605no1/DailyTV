...
public class MainActivity extends MyActivity{
            ...
            public boolean onNavigationItemSelected(MenuItem item){
                ...
                switch(id){
                    case R.id.menu_collect:
                        String name1 = headerLogin.getText().toString();
                        if(name1.equals("点击此处登录")){
    ...
    private void queryHistory(){
        ...
        //得到上一次登录信息
        name = tv.getString("name", "null");
        pwd = tv.getString("pwd", "null");
        absolutePath = tv.getString("absolutePath", "null");
        ...
        if(name.equals("null")){
            headerLogin.setText("点击此处登录");
        }else{ headerLogin.setText(name);
        isLogin=true;
        name0=name;}
    ...
    protected void onDestroy(){
        ...
        if(name != null){ edit.putString("name", name);}
        if(pwd != null){edit.putString("pwd", pwd);}
        if(pwd != null){ edit.putString("absolutePath", absolutePath);}
        edit.commit();
    }
        ...
        if(resultCode == RESULT_OK){
            switch(requestCode){
                case Constant.LOGIN:
                    ...
                    absolutePath = b.getString("absolutePath");
